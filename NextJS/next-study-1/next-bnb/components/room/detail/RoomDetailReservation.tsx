...
const RoomDetailReservation: React.FC = () => {
  ...
  const userId = useSelector((staet) => staet.user.id);
  ...
  const getGuestCountText = useMemo(() => `게스트 ${adultCount + childrenCount}명 ${
